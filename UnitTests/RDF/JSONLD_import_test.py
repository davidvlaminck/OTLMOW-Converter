...
def test_import_file_unnested_attributes(recwarn):
    file_location = Path(__file__).parent / 'Testfiles' / 'unnested_attributes.jsonld'

    objects = JsonLdImporter.to_objects(filepath=file_location, model_directory=model_directory_path)
...
def test_import_file_nested_attributes_1_level(recwarn):
    file_location = Path(__file__).parent / 'Testfiles' / 'nested_attributes_1.jsonld'
...
def test_import_file_nested_attributes_2_levels(recwarn):
    file_location = Path(__file__).parent / 'Testfiles' / 'nested_attributes_2.jsonld'
