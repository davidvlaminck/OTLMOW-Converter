...
class TtlExporterTests(unittest.TestCase):
    @staticmethod
    ...
    def test_export(self):
        ...
        file_location = Path(__file__).parent / 'Testfiles' / 'export_then_import.ttl'

        exporter = TtlExporter(settings=converter.settings, class_directory='UnitTests.TestClasses.Classes')
